...
export class ProductListComponent {
  ...
  totelProductLength = this.products.length;
  totelProcuctInStock = this.products.filter((product)=>product.is_in_inventory === true).length
  totelProductOutOfStock = this.products.filter((product)=>product.is_in_inventory === false).length

  SelectedRadioButton:string='all' //default value
